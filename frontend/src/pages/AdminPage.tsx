      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Add, edit, restock or remove vehicles from the showroom.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              className="rounded-full bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold px-6 py-2 transition"
            >
            ...
            {editingId && (
              <button
                type="button"
                onClick={cancelEdit}
                className="rounded-full border border-gray-200 text-gray-600 hover:border-blue-300 hover:text-blue-600 text-sm font-medium px-6 py-2 transition"
              >
                Cancel
              </button>
            )}
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          placeholder="Qty"
                          className="w-20 rounded-lg bg-white border border-gray-200 px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400"
                        ...
                        <button
                          ...
                          className="rounded-full bg-emerald-500 hover:bg-emerald-400 text-white text-xs font-semibold px-4 py-1.5 transition"
                        >
                          Restock
                        </button>
                      </div>
                    ...
                    <td className="px-5 py-3">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="rounded-full border border-gray-200 text-gray-600 hover:border-blue-300 hover:text-blue-600 text-xs font-medium px-4 py-1.5 transition"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDelete(vehicle.id)}
                          className="rounded-full border border-red-200 text-red-500 hover:bg-red-50 text-xs font-medium px-4 py-1.5 transition"
                        >
                          Delete
                        </button>
                      </div>
